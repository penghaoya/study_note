...
```shell
npm install @nestjs/swagger  @scalar/nestjs-api-reference nest-knife4j
```
...
- [官方文档:scalar](https://guides.scalar.com/scalar/scalar-api-references/integrations/nestjs)
